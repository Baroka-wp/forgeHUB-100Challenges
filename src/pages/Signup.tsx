  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/popup-closed-by-user') {
        setError('La fenêtre d\'inscription a été fermée. Veuillez réessayer.');
    ...
    <div className="min-h-screen flex items-center justify-center px-4 md:px-6 py-12 md:py-20 bg-surface relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8 md:mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-display font-extrabold text-on-surface mb-3 md:mb-4 tracking-tight">Créer un compte</h1>
          <p className="text-sm md:text-base text-on-surface-variant font-sans leading-relaxed">Commencez votre voyage vers vos 100 premiers clients.</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-6 md:space-y-8">
          <div className="space-y-2 md:space-y-3">
            <label className="text-[10px] md:text-[11px] font-sans font-bold text-primary uppercase tracking-[0.2em] ml-1">Nom complet</label>
