...
**Ce que tu observes sur le terrain ne ment jamais. Ce que les clients te disent en entretien, parfois, oui.**

---

### Vanity Metrics vs Actionable Metrics

Eric Ries identifie un piège dans lequel tombent presque tous les entrepreneurs débutants : se concentrer sur des chiffres qui font bonne impression mais ne révèlent rien sur la santé réelle du business.

**Vanity Metrics (flattent mais n'informent pas) :**
*   Nombre total de téléchargements
*   Nombre de followers sur les réseaux
*   Nombre de "j'aime" sur une publication
*   Nombre de visiteurs sur le site

**Actionable Metrics (révèlent la vérité) :**
*   Taux de rétention à J+7 (est-ce que les gens reviennent ?)
*   Taux de conversion (sur 100 visiteurs, combien achètent ?)
*   Coût d'acquisition client (combien dépenses-tu pour avoir un client ?)
*   Net Promoter Score (est-ce que tes clients te recommandent ?)
...
### Le Protocole de Validation en 4 Étapes
...
Après avoir présenté ton MVP, voici les questions les plus révélatrices à poser :

*"Sur une échelle de 1 à 10, à quel point seriez-vous déçu si ce produit disparaissait demain ?"*
→ Si moins de 40% des répondants disent 9 ou 10 : tu as encore du travail sur le produit.

*"À qui d'autre recommanderiez-vous ceci ?"*
→ Si la personne hésite ou ne peut nommer personne : elle n'est probablement pas convaincue.
...
Une équipe de Stanford voulait construire une tondeuse robotisée pour les campus universitaires. Ils ont présenté l'idée aux responsables d'entretien des campus : réaction enthousiaste. Ils ont construit un prototype. Résultat : personne n'a voulu payer. La main-d'œuvre locale coûtait moins cher que la machine.
...
Après tes premières validations terrain, tu te retrouveras souvent dans une zone grise : quelques signaux positifs, quelques signaux négatifs. Comment décider ?

Utilise ce cadre simple :

| Signal | Signification | Action |
|--------|--------------|--------|
| Les clients paient mais n'utilisent pas | Problème de valeur réelle | Améliore le produit avant d'acquérir plus |
| Les clients utilisent mais ne paient pas | Problème de modèle économique | Teste différents modèles de prix |
| Les clients ne paient ni n'utilisent | Problème de produit ou de cible | Retour au Chapitre 0 ou 2 |
| Les clients paient ET utilisent régulièrement | ✅ Signal de product-market fit | Passe au Chapitre 5 |
...
| Critère | Validé ? |
|---------|----------|
| J'ai observé au moins 3 clients utiliser mon MVP en conditions réelles | ☐ |
| J'ai obtenu au moins 1 paiement réel (même symbolique) | ☐ |
| J'ai identifié ma North Star Metric | ☐ |
| Je mesure des Actionable Metrics, pas des Vanity Metrics | ☐ |
| Mes clients reviennent après la première utilisation | ☐ |

**Tous cochés ?** → Passe au Chapitre 5. Tu as la preuve que ton produit crée de la valeur réelle.
