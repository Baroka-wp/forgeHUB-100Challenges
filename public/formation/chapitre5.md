...
Beaucoup de jeunes entrepreneurs, surtout ceux avec un profil technique ou créatif, ont une aversion profonde pour la vente. Ils pensent que vendre, c'est manipuler, forcer, ou se vendre soi-même.
...
### Les 3 Canaux pour tes Premiers Clients
...
### La Méthode SPIN pour les Ventes Complexes
...
### Les Leviers Psychologiques de Cialdini

Robert Cialdini a identifié 6 principes d'influence universels. Voici comment les utiliser éthiquement :
...
### Le Script de Vente Simple (pour les 100 premiers contacts)

Tu n'as pas besoin d'être un expert en persuasion. Tu as besoin d'une structure simple et honnête :

**1. L'Accroche (10 secondes) :** Nomme le problème précis de ton interlocuteur.
*"Je travaille avec des commerçants qui perdent en moyenne 2h par jour à gérer leurs stocks manuellement..."*

**2. La Curiosité (15 secondes) :** Crée de l'intérêt sans tout dévoiler.
*"...j'ai développé quelque chose qui le réduit à 10 minutes. Est-ce que ça vous parle ?"*

**3. La Preuve (30 secondes) :** Un exemple concret, un client réel.
*"Aminata, une vendeuse de tissus à Abidjan, a récupéré 1h30 par jour dès la première semaine."*

**4. L'Offre (15 secondes) :** Claire, simple, sans jargon.
*"Pour 15 000 FCFA par mois, vous avez accès à... Je vous propose qu'on essaie gratuitement pendant 7 jours."*

**5. Le Silence :** Après avoir proposé, ferme ta bouche. Le premier qui parle perd.

<div class="callout">
  <h4>Tracker tes 100 Premiers Clients</h4>
  Crée un tableau simple avec 5 colonnes : Nom | Canal d'acquisition | Date de premier contact | Statut (prospect/essai/client payant) | Prochain suivi. Revois ce tableau chaque matin. Sans tracking, tu travailles à l'aveugle.
</div>
...
→ "Bien sûr. Qu'est-ce qu'il vous faudrait savoir de plus pour prendre une décision ?" *(Ne jamais partir sans avoir identifié le vrai blocage.)*

**"Je ne suis pas sûr que ça marche pour moi."**
→ "C'est exactement pourquoi je propose 7 jours d'essai sans engagement. Si ça ne change rien à votre situation, vous ne payez rien."
...
| Critère | Validé ? |
|---------|----------|
| J'ai choisi 1 ou 2 canaux d'acquisition principaux | ☐ |
| J'ai eu au moins 10 conversations de vente réelles | ☐ |
| J'ai un script de vente que je peux réciter en 60 secondes | ☐ |
| J'ai un tableau de suivi de mes 100 prospects | ☐ |
| J'ai obtenu au moins 5 clients payants | ☐ |

**Tous cochés ?** → Passe au Chapitre 6. Tu sais maintenant comment vendre. L'enjeu devient : comment continuer à progresser.
