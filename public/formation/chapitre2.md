...
*   **Souffre activement** du problème que tu résous (score ≥ 7/10 rappelle-toi)
*   **Cherche déjà** une solution, même imparfaite
...
<div class="callout">
  ...
  "Ma cible, c'est tout le monde." Cette phrase est la mort de tout business. Plus ta cible est large, plus ton message est dilué, plus tes ressources sont dispersées. Commence ultra-petit, domine ta niche, puis étends-toi.
</div>

---

### Le Profil Micro : Aller au-delà des Données Démographiques

"Homme, 25-35 ans, urbain, diplômé" ne te dit rien d'utile. Tu ne peux pas construire un produit pour une statistique.

Le Profil Micro, c'est une description si précise que tu peux visualiser une personne réelle :

*   **Où** passe-t-il ses journées ? (bureau, terrain, domicile, marché)
*   **Quand** ressent-il le problème ? (matin, fin de mois, lors d'une commande urgente)
*   **Avec quels outils** essaie-t-il déjà de s'en sortir ? (WhatsApp, cahier, Excel, rien)
*   **Qu'est-ce qui le frustre le plus** dans les solutions actuelles ?
*   **Quelle est sa contrainte principale** ? (temps, argent, compétence, confiance)

**Donne-lui un prénom.** Appelle-le Aminata, Koffi, Mohamed. Plus il est réel dans ta tête, meilleur sera ton produit.
...
### Les 5 Entretiens Obligatoires

Avant d'écrire une seule ligne de code ou de lancer un service, tu dois avoir fait **au moins 5 entretiens de découverte client**. Pas des enquêtes Google Forms. Des conversations réelles, en face à face ou en appel vidéo, avec des gens qui ont le problème.

**La règle d'or de l'entretien :** Ne parle pas de ton produit. Pose des questions sur leur vie.

Questions à poser :

1. *"Racontez-moi la dernière fois que vous avez rencontré ce problème. Que s'est-il passé exactement ?"*
2. *"Comment l'avez-vous résolu à ce moment-là ?"*
3. *"Combien de temps / d'argent cela vous a-t-il coûté ?"*
4. *"Qu'avez-vous essayé avant ? Pourquoi ça n'a pas marché ?"*
5. *"Si ce problème disparaissait demain, qu'est-ce que ça changerait pour vous ?"*
...
### La Carte Empathie : Vivre à la Place de Ton Client

Avant de construire quoi que ce soit, passe 30 minutes à remplir cette carte :

| Dimension | Ce que tu observes |
|-----------|-------------------|
| **Ce qu'il VOIT** dans son environnement quotidien | |
| **Ce qu'il ENTEND** de ses collègues, amis, supérieurs | |
| **Ce qu'il PENSE et RESSENT** (ses vraies préoccupations) | |
| **Ce qu'il DIT et FAIT** (son comportement visible) | |
| **Ses DOULEURS** (peurs, frustrations, obstacles) | |
...
| Critère | Validé ? |
|---------|----------|
| J'ai créé un Profil Micro précis pour mon Adopteur Précoce | ☐ |
| J'ai identifié le "Job to be Done" principal de mon client | ☐ |
| J'ai conduit au moins 5 entretiens de découverte réels | ☐ |
| Je connais les mots exacts que mes clients utilisent pour décrire leur douleur | ☐ |
| J'ai identifié ce que mon client doit "licencier" pour m'adopter | ☐ |

**Tous cochés ?** → Passe au Chapitre 3. Tu connais désormais ton client mieux qu'il ne se connaît lui-même.
